...
% -- MiA Modifications Copyright 2020 --
%   - California Polytechnic State University San Luis Obisp
% The methods in this script and all accompanying scripts called from this
% script have been reformatted to accept MATLAB's package dictation.
% Additionally, the visual output of the program has been modified to
% write to the String property of any associated object with the tag 'Status
% Bar'.
...
for s = 1:numSeries
    % Modified from original to read out to the status bar of the parent
    % figure
