...
%           San Luis Obispo, CA 93407
    ...
    properties(Access = private)
       orig_file_filters =  {'CZI Files (*.czi,*.CZI)',{'czi';'CZI'},;...                   % default file filter set
              'RGB Files (*.tif,*.tiff,*.TIF,*.TIFF)',{'tif';'tiff';'TIF';'TIFF'};...
       ...
       function obj = load_image(obj,src)
        ...
        if ~strcmp(class(src),'Figure.file_select_display') %#ok<STISA> Compared class is custom
            ...
            if filterIndex ~= 0
                ...
                % next load
                logiFilter = cellfun(@(x)isequal(x,imag_fp_handle.browseFilter{filterIndex,1}),obj.orig_file_filters(:,1));
