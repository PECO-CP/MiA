...
%       'c'                         : On/Off Pointer Symbol 'crosshair'
...
%% -- MiA Modifications (c) 2022 --
% For dragzoom's adaptation to MiA, a great deal of modfications have been
% implemented to allow use with normalized figures and to reset constant
% graphical values between image loadings in a single MiA session. The 3D
% methods do not apply to MiA, but all 2D methods and uses should still
% work properly.

% Last Modified by JONATHAN HOOD v3.0 Sep-2022

% MiA Functions package within Figure package providing program-wide functions for
